        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="{{ route('guru.index') }}" class="menu-link">
                                <div data-i18n="Without navbar">Guru</div>
                            </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="layouts-container.html" class="menu-link">
                                <div data-i18n="Container">Siswa</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-fluid.html" class="menu-link">
                                <div data-i18n="Fluid">Mata Pelajaran</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-blank.html" class="menu-link">
                                <div data-i18n="Blank">Jadwal Mengajar</div>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    <a href="{{ route('manajemenuser.index') }}" class="menu-link">
